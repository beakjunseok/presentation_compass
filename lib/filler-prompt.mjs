...
export function buildGeminiRequest(tokens) {
  return {
    model: GEMINI_MODEL,
    body: {
      systemInstruction: { parts: [{ text: SYSTEM_INSTRUCTION }] },
      contents: [{ role: "user", parts: [{ text: buildUserContent(tokens) }] }],
      generationConfig: {
